...
#include "nesl_rtw.h"
#include "Chapter_9_Section_5_a65846e1_1.h"
#include "Chapter_9_Section_5_a65846e1_1_gateway.h"

void Chapter_9_Section_5_a65846e1_1_gateway(void)
{
  NeModelParameters modelparams = { (enum NeSolverTypeTag)0, 0.001, 0.001, FALSE,
    FALSE, 0.1, 0.0, FALSE, FALSE, FALSE, (enum SscLoggingSettingTag)1,
    703102941.0, TRUE, FALSE };
  ...
  NeSolverParameters solverparams = { TRUE, TRUE, FALSE, FALSE, TRUE, FALSE,
    ...
    NeCanonicalOrderingTag)1, (enum NeOptimizeIntermediatesTag)1, (enum
    NeIndexReductionMethodTag)1, FALSE, 1e-09, (enum NeToleranceSourceTag)1,
    0.001, 0.001, 0.001, FALSE, (enum NeLocalSolverChoiceTag)0, TRUE, 1U, 0.001,
    FALSE, 3U, 2U, FALSE, 2U, (enum NeLinearAlgebraChoiceTag)0, 0U, (enum
  ...
  Chapter_9_Section_5_a65846e1_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("Chapter_9_Section_5/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
